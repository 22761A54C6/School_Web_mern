...
const TableTemplate = ({ buttonHaver: ButtonHaver, columns, rows, title = "Data Table" }) => {
    ...
    return (
        <TableWrapper>
            <TableHeader>
                ...
                <TableSubtitle>Showing {rows.length} records</TableSubtitle>
            </TableHeader>
                            ...
                            <StyledTableRow>
                                <StyledTableCell colSpan={columns.length + 1} align="center">
                                    <EmptyState>
                                        ...
                                        <EmptySubtext>There are no records to display at the moment.</EmptySubtext>
                                    </EmptyState>
                                </StyledTableCell>
                            </StyledTableRow>
                        ) : (
