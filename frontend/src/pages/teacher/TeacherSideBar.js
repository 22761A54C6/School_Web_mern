    ...
    return (
        <SidebarContainer>
            <SidebarHeader>
                ...
                <HeaderText>
                    <HeaderTitle>Teacher</HeaderTitle>
            ...
            <NavigationSection>
                ...
                >
                    <NavIcon active={isActive("/Teacher/class")}>
                        <ClassOutlinedIcon />
                    </NavIcon>
                    <NavText active={isActive("/Teacher/class")}>
                        Class {sclassName?.sclassName || 'Details'}
                    </NavText>
                    <ActiveIndicator active={isActive("/Teacher/class")} />
                </NavItem>
                ...
                >
                    <NavIcon active={isActive("/Teacher/complain")}>
                        <AnnouncementOutlinedIcon />
                    </NavIcon>
                    <NavText active={isActive("/Teacher/complain")}>Complain</NavText>
                    <ActiveIndicator active={isActive("/Teacher/complain")} />
                </NavItem>
            </NavigationSection>
            ...
            <UserSection>
                ...
                >
                    <NavIcon active={isActive("/Teacher/profile")}>
                        <AccountCircleOutlinedIcon />
                    </NavIcon>
                    <NavText active={isActive("/Teacher/profile")}>Profile</NavText>
                    <ActiveIndicator active={isActive("/Teacher/profile")} />
                </NavItem>
